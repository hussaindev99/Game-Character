            ...
            <div className="min-h-screen mt-10 bg-black text-white">
                <div className="max-w-7xl mx-auto p-6">
                    ...
                    <h1 className="text-3xl font-bold mb-6 mt-10">
                        3D <span className="bg-gradient-to-r from-pink-500 to-blue-500 bg-clip-text text-transparent hover:underline hover:underline-offset-8">Printing Services</span>
                    </h1>
