    ...
    return (
        ...
        <div className="min-h-screen mt-10 bg-black text-white">
            <div className="max-w-7xl mx-auto p-6">
                {/* Heading */}
                <h1 className="text-3xl font-bold mb-6">3D <span className="bg-gradient-to-r from-pink-500 to-blue-500 bg-clip-text text-transparent hover:underline hover:underline-offset-8">Printing Services</span> </h1>

                {/* Service Cards */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    {/* Digital & Physical Models */}
                    <div className="bg-[#1b1b1b] p-8 rounded-lg shadow-md ">
                        <h2 className="text-xl font-bold mb-4">Digital & Physical 3D Models</h2>
                        <p className="text-gray-400 mb-6">
                            We offer both digital copies (.STL files) and physical copies (3D printed models) of a wide range of designs. Choose from our collection of models and get them in the format you prefer
                        </p>
                    ...
                    <div className="bg-[#1b1b1b] p-8 rounded-lg shadow-md ">
                        <h2 className="text-xl font-bold mb-4">Physical 3D Models Only</h2>
                        <p className="text-gray-400 mb-6">
                            {" We offer both digital copies (.STL files) and physical copies (3D printed models) of a wide range of designs. Choose from our collection of models and get them in the format you prefer"}
                        </p>
                        <button className="bg-[#fd4960] hover:bg-[#ff2442]  text-white py-3 px-12 rounded-full transition duration-300">
                ...
                {/* File Upload Section */}
                <div className="bg-[#1b1b1b] p-6 rounded-lg shadow-md text-center mb-8">
                    <h2 className="text-xl font-bold mb-4">Custom 3D Printing Orders</h2>
                    <p className="text-gray-400 mb-6">
                        {" Have your own design? Upload your STL file, and we’ll review it to provide you with a quote for 3D printing."}
                    </p>

                    {/* Drag and Drop Area */}
                    <div
                        className="border-2 mx-[18%] border-dashed border-gray-600 rounded-lg p-6 h-72 flex flex-col justify-center items-center cursor-pointer"
                    ...
                    <div className="mt-6 mx-[18%] rounded-lg">
                        <textarea
                            type="text"
                ...
                {/* Footer Scanning Section */}
                <div className="bg-[#1b1b1b] p-6 rounded-lg shadow-md ">
                    <h2 className="text-xl font-bold mb-4">Scanning Services</h2>
                    <p className="text-gray-400 mb-6 pr-32">
                        {"We offer both digital copies (.STL files) and physical copies (3D printed models) of a wide range of designs. Choose from our collection of models and get them in the format you prefer"}
                    </p>
                    <button className="bg-[#fd4960] hover:bg-[#ff2442]  text-white py-3 px-12 rounded-full transition duration-300">
                        Contact Us
