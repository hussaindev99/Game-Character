                    ...
                    <div className="bg-[#1b1b1b] p-8 rounded-lg shadow-lg">
                        ...
                        <div className="flex justify-between mb-6">
                            ...
                            <div className="w-[48%] mt-10">
                                <label className="block mb-2 text-white ">Category ID</label>
                                <input
                                    type="text"
                                    className="w-full text-lg bg-[#2b2b2b] h-14 text-gray-200 px-4 py-2 rounded-md outline-none border border-gray-300"
                                    placeholder="345123"
                        ...
                        <div className="flex justify-end mt-8">
                            <button className="bg-[#2b2b2b] text-gray-300 px-20 py-3 rounded-full mr-4">
                                Cancel
                            </button>
                            <button className="bg-[#fd4960] hover:bg-[#ff2f4b] text-white px-20 py-3 rounded-full">
                                Save
                            </button>
                        </div>
