            ...
            <div className=" p-8 rounded-xl w-full  shadow-lg">
                ...
                <form className="space-y-4">
                    ...
                    <div className="flex items-center justify-between text-sm">
                        ...
                        <Link href="/ResetPassword" className="bg-gradient-to-r from-pink-500 to-blue-500 bg-clip-text text-transparent hover:underline hover:underline-offset-8">Forgot Password?</Link>
                    </div>
