  ...
  return (
    <div >
      ...
      <div className="flex w-full">
        ...
        <div className="w-[80%] p-8 bg-[#0a0a0a] text-white min-h-screen ">
          {/* Cards Section */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {["Total Revenue ", "Total Income", "Total Orders"].map((title, index) => (
              <div
                key={index}
                className="bg-[#1B1B1B] p-6 rounded-lg flex flex-col items-center shadow-md space-y-2"
              >
          ...
          <div className="bg-[#1B1B1B] mt-10 p-6 rounded-lg shadow-md">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className=" flex items-center border border-gray-600 rounded-full">
                <p className="bg-transparent text-2xl text-white py-2 pl-3 rounded-l-full  "><CiSearch /></p>
                <input
                  type="text"
                  placeholder="Search product"
                  className="bg-transparent text-white py-2 px-1 rounded-r-full w-64 outline-none "
                />
                    ...
                    <tr key={index} className="border-b border-gray-700">
                      ...
                      <td className="py-3 px-4 text-right">
                        <button className="bg-gray-700 p-2 rounded-full">
                          <i className="fa fa-ellipsis-h text-white"><BsThreeDotsVertical /></i>
                        </button>
                      </td>
                    </tr>
                  ))}
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <div className="flex space-x-2 items-center">
                <p className="h-8 w-8 items-center flex bg-[#262626] text-xl justify-center rounded-full"> <IoIosArrowBack /></p>
                ...
                <p className="h-8 w-8 items-center flex bg-[#262626] text-xl justify-center rounded-full"> <IoIosArrowForward /></p>
              </div>
            </div>
          </div>
        </div>
