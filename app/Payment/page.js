...
const Payment = () => {
    ...
    return (
        <>
        <Navbar />
            <p className="text-3xl font-bold mx-20 mt-14">Payment</p>
            <div className="min-h-screen bg-black text-white p-6 flex justify-center items-center">
                <div className="max-w-4xl w-full flex flex-col lg:flex-row shadow-lg">

                    {/* Summary Section */}
                    <div className="w-full lg:w-1/2 p-6 bg-[#1B1B1B] rounded-xl ">
                        ...
                        <div className="space-y-4">
                            {Array(3)
                                ...
                                .map((_, index) => (
                                    <div
                                        key={index}
                                        className="flex items-center justify-between bg-white text-black rounded-md p-2"
                                    >
                    ...
                    {/* Payment Section */}
                    <div className="w-full lg:w-1/2 p-6 rounded-r-lg">
                        ...
                        <div className="flex space-x-4 mb-6">
                            {["Credit Card", "PayPal", "PayPal Credit"].map((method) => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-md ${activeMethod === method
                                        ? ""
                        ...
                        {activeMethod === "Credit Card" && (
                            <Image src={creditcard} alt="Credit Card Payment" className="mb-4" />
                        )}
                        {activeMethod === "PayPal" && (
                            <Image src={paypal} alt="PayPal Payment" className="mb-4 w-[383px] h-[216px] rounded-2xl" />
                        )}
                        {activeMethod === "PayPal Credit" && (
                            <Image src={mastercard} alt="PayPal Credit Payment" className="mb-4 w-[383px] h-[216px] rounded-lg" />
                        )}
