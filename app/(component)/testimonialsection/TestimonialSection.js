    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center mt-12 ">
                <div className="w-full max-w-[80%] p-20 bg-gradient-to-r from-red-500 to-red-900 rounded-xl shadow-lg">
                    ...
                    <div className="flex items-center justify-center">
                        <input
                            ...
                            className="w-[70%] py-3 px-4 rounded-l-full bg-black text-white placeholder-gray-500 focus:outline-none"
                        />
