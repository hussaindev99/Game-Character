        ...
        <>
            ...
            <div className="bg-black text-white min-h-screen p-6">
                ...
                {activeTab === "description" && (
                    <div className="text-gray-400 mx-[4.5%] mb-12">
                        {/* Add your description content here */}
                        <h2 className="text-2xl font-bold">Product Description</h2>
                        <p>
                            Here goes the product description content. You can add detailed
                ...
                {activeTab === "reviews" && (
                    <>
                        {/* Ratings Section */}
                        <div className="flex justify-between mx-[4.5%] border-b border-gray-700 pb-6 mb-12">
                            {/* Left: Star Rating */}
                            <div>
                            ...
                            <div className="w-[60%] space-y-4 mb-10 border-r rounded-sm border-gray-700">
                                {[5, 4, 3, 2, 1].map((star) => (
