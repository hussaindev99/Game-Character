...
const ProcessWork = () => {
    ...
    return (
        <>
        <section className="bg-gradient-to-tr from-[#e94e963d] via-black  to-[#002fff3d] text-white py-16 px-4">
            <div className="max-w-6xl mx-auto text-center">
                {/* Heading */}
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                    The Process : <span className="font-bold">How</span> <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6757D0] to-blue-500"> We Work</span>
                </h2>
                <p className="text-gray-300 text-lg mb-12 text-center w-full flex px-[12%]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {steps.map((step) => (
                        ...
                        >
                            ...
                            <div className="flex items-center font- justify-center w-12 h-12 bg-gradient-to-br from-[#e94e96] via-[#A041AA]  to-[#002fff] text-white rounded-full text-2xl font-bold mb-4 mx-auto">
                                {step.id}
                            </div>
                            {/* Step Title */}
        ...
        <section className="w-full max-w-6xl p-9 mx-auto">
            ...
            <div className="flex space-x-4">
                {/* Testimonial Card */}
                <div className="bg-[#1b1b1b] p-14 rounded-lg w-[60%] flex">
            ...
            <div className="flex justify-center mt-4">
                <button className="text-gray-500 hover:text-white focus:outline-none mx-2">
