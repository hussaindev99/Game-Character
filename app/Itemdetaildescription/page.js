                ...
                <div className="min-h-screen text-white py-12 px-6">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className=" rounded-lg p-6 md:p-8">
                            {/* Images Grid */}
                            <div className="gap-7 mb-6 flex w-full">
                                <Image
                                    src={Showcase}
                                    alt="Main Character"
                                    className="rounded-lg object-cover w-[70%]"
                                />
                                <div className='w-[30%] gap-7'>
                            ...
                            <p className="text-white mb-4 bg-[#1B1B1B] w-[43%] rounded-md px-4 py-2">
                    ...
                    <div className='flex gap-7 ml-[5%]'>
                        <Image src={cartoon} alt="" className='w-[47%]' />
                        <Image src={cartoon1} alt="" className='w-[47%]' />
                    </div>
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div>
                            ...
                            <div className="mb-6">
                                ...
                                <ul className="list-disc flex list-inside  gap-4">
            ...
            <section className='w-full'>
                <div className="text-white py-10">
                    ...
                    <div className="container px-[4%] mb-10">
                        <div className="grid grid-cols-3 gap-4 mr-[-200px] w-full ml-9">
